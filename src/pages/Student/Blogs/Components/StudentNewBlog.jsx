// src/components/StudentNewBlog.jsx
...
const StudentNewBlog = () => {
  const navigate = useNavigate();
  const dispatch = useDispatch();
  const { user } = useSelector((state) => state.userSlice); // Assuming userSlice stores authenticated user data

  const [formData, setFormData] = useState({
    title: '',
    authorType: 'student', // Set to 'student' for student submissions
    authorId: '', // Will be set from user._id
    authorName: '', // Will be set from user.name
    authorProfilePic: '',
    tags: [],
    poster: '',
    description: '',
    category: '',
    published: false, // Always false for student submissions
  ...
  // Set authorId and authorName from authenticated user
  useEffect(() => {
    if (user) {
      setFormData((prev) => ({
        ...prev,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/student/blogs'); // Navigate to student blog list
    } catch (error) {
      toast.error(error || 'Error creating blog');
    ...
    <div className="min-h-screen bg-dark p-6 text-white">
      <div className="max-w-4xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-big font-bold text-white">Submit New Blog</h1>
          <button
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
              ...
              <input
                ...
                required
                disabled // Disable to prevent changing authenticated user's name
              />
            </div>
          </div>
          ...
          <div className="mt-8 flex justify-end">
            ...
            <button
              ...
              className="btn-primary flex items-center text-small"
            >
              <FiCheck className="mr-2" /> Submit Blog
            </button>
          </div>
        </form>
      </div>
