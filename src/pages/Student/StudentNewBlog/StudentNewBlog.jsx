...
const StudentNewBlog = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    authorId: '', // Placeholder; can be updated later with auth
    authorName: '', // Manually entered by student
    authorProfilePic: '', // Optional; default empty
    tags: [],
    poster: '',
    description: '',
    category: '',
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.title || !formData.authorName || !formData.description || !formData.category) {
