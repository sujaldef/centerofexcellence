...
const EditBlog = () => {
  ...
  // Populate form with fetched blog data
  useEffect(() => {
    if (selectedBlog && selectedBlog._id === id) {
      setFormData({
        title: selectedBlog.title || '',
        poster: selectedBlog.poster || '',
        description: selectedBlog.description || '',
        authorName: selectedBlog.authorName || '',
        category: selectedBlog.category || '',
        tags: selectedBlog.tags || [],
        status: selectedBlog.status || 'pending',
        authorProfilePic: selectedBlog.authorProfilePic || '',
      });
      setPreviewImage(selectedBlog.poster || null);
    }
  }, [selectedBlog, id]);
    ...
    <div className="min-h-screen bg-dark p-6 text-white">
      <div className="max-w-4xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-big font-bold text-white">Edit Blog</h1>
          <button
